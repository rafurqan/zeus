...
const tabs = ['Data Pribadi', 'Sekolah Asal', 'Dokumen', 'Keluarga', 'Informasi Tambahan'];
...
export default function CreateProspectiveStudentsPage() {
    ...
    const [preview, setPreview] = useState<string | null>(item?.photo_filename ?? null);
    ...
    useEffect(() => {
        if (item?.photo_filename) {
            setPreview(item?.photo_filename);
        }
    }, [item?.photo_filename]);
